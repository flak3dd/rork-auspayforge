...
<p style="font-size:10pt;margin:8px 0"><strong>Name:</strong> ${holder}</p>
<p style="font-size:9.8pt;line-height:1.35;margin-top:18px"><strong>Note:</strong> Have you checked your statement today? It's easy to find out more information about each of your transactions by logging on to the CommBank App or NetBank.</p>
<div class="yellow-divider"></div>
...
<tbody>`;
    ...
    if (p === totalPages - 1) {
      html += `<div style="margin-top:40px;font-size:9pt;line-height:1.4">
